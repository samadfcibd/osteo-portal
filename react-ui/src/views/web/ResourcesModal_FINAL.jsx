...
const useApi = () => {
    ...
    return useMemo(() => ({
        fetchOrganisms: (stage, page, perPage) =>
            axios.get(`${baseURL}organisms`, {
                params: { stage, page, per_page: perPage }
            }),

        fetchReviews: (organismId) =>
            axios.get(`${baseURL}organisms/${organismId}/reviews`),

        fetchRating: (organismId) =>
            axios.get(`${baseURL}organisms/${organismId}/rating`),

        submitRating: (organismId, data) =>
            axios.post(`${baseURL}organisms/${organismId}/rating`, data)
    }), [baseURL]);
};
